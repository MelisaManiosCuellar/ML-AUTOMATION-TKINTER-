...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.button_1.place(relx=0.5, rely=0.2, anchor=tkinter.CENTER)
        self.button_2 = customtkinter.CTkButton(self.sidebar_frame,text="K-Means")
        self.button_2.place(relx=0.5, rely=0.25, anchor=tkinter.CENTER)
        self.button_3 = customtkinter.CTkButton(self.sidebar_frame,text="Multinomial Naive-Bayes")
        self.button_3.place(relx=0.5, rely=0.3, anchor=tkinter.CENTER)
        self.button_4 = customtkinter.CTkButton(self.sidebar_frame, text="SVM Classifier")
        self.button_4.place(relx=0.5, rely=0.35, anchor=tkinter.CENTER)
        self.button_5 = customtkinter.CTkButton(self.sidebar_frame, text="SVM Regressor")
        self.button_5.place(relx=0.5, rely=0.42, anchor=tkinter.CENTER)
        self.button_6 = customtkinter.CTkButton(self.sidebar_frame, text="Lasso Regression")
        self.button_6.place(relx=0.5, rely=0.47, anchor=tkinter.CENTER)
        self.button_7 = customtkinter.CTkButton(self.sidebar_frame, text="Ridge Regression")
        self.button_7.place(relx=0.5, rely=0.53, anchor=tkinter.CENTER)
        # # self.button_8 = customtkinter.CTkButton(self.sidebar_frame, text="Linear Regression")
        # # self.button_8.grid( row=2, column=3, padx=4, pady=(4))
        # # self.button_9 = customtkinter.CTkButton(self.sidebar_frame, text="Logistic Regression")
        # # self.button_9.grid( row=3, column=3, padx=4, pady=(4))
        # # self.button_10 = customtkinter.CTkButton(self.sidebar_frame, text="MLP Classifier")
        # # self.button_10.grid( row=1, column=3, padx=4, pady=(4))
        # # self.button_11 = customtkinter.CTkButton(self.sidebar_frame, text="DecisionTree Regressor")
        # # self.button_11.grid( row=1, column=4, padx=4, pady=(4))
        # # self.button_12 = customtkinter.CTkButton(self.sidebar_frame, text="DecisionTree Classifier")
        # # self.button_12.grid( row=2, column=4, padx=4, pady=(4))
        # # self.button_13 = customtkinter.CTkButton(self.sidebar_frame, text="Best Classifier and Regressor")
        # # self.button_13.grid( row=3, column=4, padx=4, pady=(4))
